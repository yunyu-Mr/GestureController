...
/**
 * Gesture Recognition Service is a integrate interface of ccaal.
 * Wrapping Recorder and Classifier method
 * @author smtech
 *
 */
public class GestureRecognitionService extends Service implements GestureRecorderListener {
	...
	IBinder gestureRecognitionServiceStub = new IGestureRecognitionService.Stub() {
		...
		/**
		 * Get the gesture labels in a trainingSet
		 */
		@Override
		...
		/**
		 * Filtering the slightly movements of users by thresholding.
		 * 
		 */
		@Override
	...
	/**
	 * If is learning, classifier would write data to the file.(dir: /Android/data/de.dfki.ccaal.gesture/file/)
	 * If is classifying, classifier would load training set from xxx.gst (dir is the same)
	 */
	@Override
